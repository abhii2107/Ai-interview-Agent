      ...
      <div className='w-full max-w-6xl bg-white rounded-3xl shadow-2xl grid md:grid-cols-2 overflow-hidden'>
        <motion.div
          ...
          <p className='text-gray-600 mb-10'>
            Practice real interview scenarios powered by AI.Improve your communication, technical skills, and confidence with personalized feedback. Get ready to ace your next interview!
        ...
        >
          ...
          <div className='space-y-6'>
            <div className='relative'>
              <FaUserTie className='absolute top-4 left-4
                text-gray-400 t' />
            ...
            <div className='relative'>
              <FaBriefcase className='absolute top-4 left-4
                text-gray-400 t' />

              <input type="text" placeholder="Experience (e.g. 2 years)" className='w-full pl-12 pr-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-green-500 outline-none transition'
