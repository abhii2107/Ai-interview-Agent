...
import evalImg from "../assets/answer.png"
              ...
              [
                {
                  ...
                  desc: "AI adjusts the difficulty based on your chosen job role."
                },
                {
                  icon: <BsMic size={24} />,
                  step: "STEP 2",
                  title: "Smart Voice Interview",
                  desc: "Practice your responses in a realistic interview environment."
                }
                ,
                {
                  ...
                  desc: "Test your ability to think under pressure with timed scenarios."
                }
              ].map((item, index) => (
                <motion.div key={index}
                  ...
                  className={
                    `
                                relative bg-white rounded-3xl border-2 border-green-100 hover:border-green-500 shadow-md p-10 w-80 max-w-[90%] hover:shadow-2xl
            ...
            <div className="grid md:grid-cols-2 gap-10 ">
              {
                [
                  ...
                  },
                  {
                    image: pdfImg,
                    icon: <BsFileEarmarkText size={20} />,
                    title: "PDF Based Interview",
                    desc: "Detail strengths, weaknesses and improvement insights."
                  },
                  {
                    image: analyticsImg,
                    icon: <BsBarChart size={20} />,
                  ...
                  <motion.div key={index}
                    ...
                    className="bg-white border-gray-200 rounded-3xl p-8 shadow-sm hover:shadow-xl tansition-all">
                    <div className="flex flex-col md:flex-row items-center gap-8">
                      ...
                      <div className="w-full md:w-1/2">
                        <div className="bg-green-50 tect-green-600 w-12 h-12 rounded-xl flex items-center justify-center mb-6">{item.icon}</div>
                ...
                [
                  {
                    ...
                    desc: "Practice common HR interview questions and improve your responses."
                  },
                  {
                    image: techImg,
                    title: "Technical Mode",
                    desc: "Tackle coding challenges and technical questions with confidence."
                  },
                  {
                    image: confidenceImg,
                    title: "Confidence Detection",
                    desc: "Identify and improve your confidence levels during interviews."
                  },
                  {
                    image: creditImg,
                    title: "Credit Based System",
                    desc: "Earn credits for practice and redeem them for premium features."
                  }
                ].map((mode, index) => (
                  <motion.div key={index}
                    initial={{ opacity: 0, y: 30 }}
